...
void print_types (List *list, SchemaType *head) { List *l;
  ...
  print ("#ifndef SE_TYPES_H\n");
  print ("#define SE_TYPES_H\n");
...
void print_schema (List *sorted, SchemaDoc *doc) {
  ...
  qnames = list_reverse (names);
  print ("const char * const se_names[] = {");
  foreach (q, qnames) print ("\"%s\", \n", q->data);
  print ("};\n\n");
  ...
  foreach (s, sorted) {
    ...
    if (t->name) print ("0, \n");
    foreach (te, t->entries)
      print ("%d, \n", find_index_by_name (qnames, te->name));
  }
  print ("};\n\n");
